        ...
        <div class="w-full max-w-md">
            <div class="bg-white rounded-2xl shadow-lg p-8 space-y-6">
                ...
                <div class="text-center space-y-3">
                    ...
                    <h1 class="text-2xl font-bold text-gray-900">BankSync</h1>
                    <p class="text-sm text-gray-600">Conciliación bancaria con IA</p>
                </div>

                <!-- Título del formulario -->
                <div class="pt-4">
                    <h2 class="text-lg font-semibold text-gray-900 mb-1">Crear cuenta</h2>
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div class="flex items-start">
                        ...
                        <label class="ml-2 text-sm text-gray-600">
                            Acepto los <a href="#" class="text-blue-600 hover:text-blue-700 font-medium">términos y condiciones</a> y la <a href="#" class="text-blue-600 hover:text-blue-700 font-medium">política de privacidad</a>
                        </label>
                    </div>

                    <button 
                        type="submit" 
                        class="w-full bg-blue-600 text-white font-semibold py-3 rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-sm"
                    >
                        Crear cuenta
                    </button>
                </form>
                ...
                <div class="text-center pt-4">
                    <p class="text-sm text-gray-600">
                        ¿Ya tienes cuenta? 
                        <router-link to="/" class="font-semibold text-blue-600 hover:text-blue-700 transition-colors">
                            Inicia sesión
                        </router-link>
                    </p>
                </div>
